...
def generate_cls_order(num_of_cls=91, seed=123, shuffle=True):
    """The function to create the class order for incremental learning.
    Args:
        num_of_cls: the number of classes.
        seed: the random seed.
        shuffle: whether to shuffle (image_split) or keep default order (class_split).
    """
    ...
    print('current shuffle: ' + str(shuffle))
